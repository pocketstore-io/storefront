  ...
  <section v-if="checkoutStep == 'customer'" class="page bg-red-400 mx-auto max-w-6xl">
    <div class="grid grid-cols-6">
        ...
        <div class="hero-content flex-col lg:flex-row-reverse">
          ...
          <div class="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
            ...
            <section v-else class="card-body">
              ...
              <button class="btn btn-sm btn-secondary" @click="checkoutStep = 'addresses'">{{ pb.authStore.model?.name
                }}</button>
            </section>
          </div>
        </div>
      ...
      <div class="col-span-6 flex justify-between py-3">
        ...
        <button class="btn btn-primary" :disabled="!pb.authStore.isValid" @click="checkoutStep = 'addresses'"><span>{{
          $t('checkout.continue.addresses') }}</span>
