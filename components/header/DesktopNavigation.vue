<template>
  <nav class="hidden md:flex items-center text-white">
    <ul class="flex space-x-6 text-sm font-bold items-center mr-6">
      ...
      <li>
        <a href="https://www.pocketstore.io/shops/">
          Shops
        </a>
      </li>
    </ul>
    <ul class="flex space-x-3">
      <li>
        <a href="https://github.com/pocketstore-io/demo" target="_blank" class="flex justify-center items-center btn btn-primary text-white">
